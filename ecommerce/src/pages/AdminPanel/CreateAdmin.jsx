...
const CreateAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // On success, save admin data to localStorage
       setSuccessMessage('Create Admin successful!');
       setError({});
      ...
      setSuccessMessage('');
      setError({ apiError: err.response?.data?.message || 'Create Admin failed' });
    }
  };
      ...
      <Grid container style={{ minHeight: '90vh' }}>
        ...
        {/* <Grid item xs={12} sm={12}> */}
          <Box display="flex" justifyContent="center" alignItems="center" height="100%">
            <Paper elevation={3} style={{ padding: '30px', width: {xs:'400px',md:"500px",lg:"700px"} }}>
